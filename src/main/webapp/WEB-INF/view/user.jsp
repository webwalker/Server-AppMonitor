...
<body>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form:form id="ff" method="post" modelAttribute="user">
			...
			<div class="fitem">
				<label>登录密码:</label>
				<form:password path="userPass" maxlength="25"
					class="easyui-textbox"
					data-options="validType:'length[6,25]'" style="width:150px" />
				为空不修改
			</div>
			<div class="fitem">
				<label>确认密码:</label> <input type="password" id="confPass"
					maxlength="25" class="easyui-textbox"
			...
			<div class="fitem">
				<label>用户描述:</label>
				<form:textarea path="description" class="easyui-textbox"
